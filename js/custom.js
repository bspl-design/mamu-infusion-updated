...
;
        ...
        // Toggle overflow: hidden on body when mobile menu is toggled
        document.addEventListener("DOMContentLoaded", () => {
            ...
            if (menuToggle) {
                ...
                // Close menu and restore scrolling when any menu link is clicked
        ...
        // Infinite Client Marquee Group Cloner
        document.addEventListener("DOMContentLoaded", () => {
